      ...
      <nav className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-2 shrink-0">
          ...
          <a href="https://www.instagram.com/betterdoseltd" target="_blank" rel="noopener noreferrer" aria-label="BetterDose Instagram"
            className="w-7 h-7 rounded-lg border border-[#252d3d] flex items-center justify-center text-[#8b92a9] hover:text-[#e1306c] hover:border-[#e1306c]/40 hover:bg-[#e1306c]/10 transition-all">
          ...
          <a href="https://t.me/betterdose" target="_blank" rel="noopener noreferrer" aria-label="BetterDose Telegram"
            className="w-7 h-7 rounded-lg border border-[#252d3d] flex items-center justify-center text-[#8b92a9] hover:text-[#229ED9] hover:border-[#229ED9]/40 hover:bg-[#229ED9]/10 transition-all">
